...
class Wallet:
    ...
    Allows a miner to suthorize transaction
    """
    ...
    def verify(public_key, data, signature):
        """
        Verify a signature based on the public key and signature.
        """
    ...
    def calculate_balance(blockchain, address):
        """
        Calculate balance of the given address considering the transaction
        ...
        for block in blockchain.chain:
            for transaction in block.data:
                if transaction['input']['address'] == address:
                    # Any time an address conducts a transaction it resets
                    # it's balance
