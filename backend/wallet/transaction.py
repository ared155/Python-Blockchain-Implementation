...
class Transaction:
    ...
    def from_json(transaction_json):
        """
        Deserialize transaction's json representation back into a
    ...
    def is_valid_transaction(transaction):
        ...
        Rasie an exception for invalid transaction.
        """
    ...
    def reward_transaction(miner_wallet):
        """
        Generate a reward transactioin that award the miner.
        """
        output={}
